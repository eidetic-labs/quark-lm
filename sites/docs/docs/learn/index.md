...
| [Forward research plan](./forward-research-plan.md) | You want the v0.69 strategy sequence through the v0.86 adaptive baseline-floor retry screen. |
| [Deep research review](./deep-research-review.md) | You want the v0.70 cross-referenced literature, open-source mechanics, QuarkLM gap review, and v0.86 rejected screen handoff. |
| [Research implementation map](./research-implementation-map.md) | You want the v0.74 source-to-gap-to-version map and the v0.86 adaptive baseline-floor retry evidence. |
