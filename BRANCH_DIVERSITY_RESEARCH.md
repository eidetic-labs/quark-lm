...
`branch_diversity_target.root_cause`, and v0.113 adds
...
4. Add candidate construction and sampling diagnostics for profile/target
   imbalance.
5. Only then choose a repair objective, and require both the root-cause report
   and routing audit to improve without relaxing `branch_diversity_target`.
