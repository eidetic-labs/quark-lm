...
| [Forward research plan](./forward-research-plan.md) | You want the v0.69 strategy sequence, v0.70 research checkpoint, and v0.71 handoff from experiment registry to replay extraction. |
| [Deep research review](./deep-research-review.md) | You want the v0.70 cross-referenced literature, open-source mechanics, QuarkLM gap review, and v0.71 implementation handoff. |
