"""Evidence checks for retention-anchored rank routing repair."""
...
def retention_rank_routing_repair_checks(
    ...
    coverage_preserved = (
        _coverage_surface_present(coverage_delta)
    ...
    return [
        promotion_check(
            ...
            "Bundle D must record profile-balanced branch batches.",
            {"batch_evidence": batch_evidence},
        ),
        promotion_check(
            "retention_rank_margin_pressure",
            _retention_rank_pressure_configured(direct_answer),
            (
                "Bundle D must apply profile-balanced rank-margin pressure "
                "with retention anchors."
            ),
            {
        ...
        promotion_check(
            ...
            "Bundle D must record retention-anchor preservation attempts.",
            {
        ...
        promotion_check(
            ...
            "Bundle D must record representation-separation evidence.",
            {
        ...
        promotion_check(
            ...
            coverage_preserved,
            "Bundle D must reject target-token coverage regressions.",
            coverage_delta,
        ),
        promotion_check(
            "branch_diversity_acceptance_gate",
            diversity_passed,
            "Bundle D accepts only when branch-diversity evidence passes.",
            {"branch_diversity_target": diversity},
        ),
        promotion_check(
            "retention_rank_pressure_requires_branch_response",
            _retention_rank_pressure_configured(direct_answer) and branch_responded,
            (
                "Bundle D must reject retention-anchored rank movement when target "
                "coverage and target-rank branch-diversity score remain unchanged."
            ),
            {
...
def _retention_rank_pressure_configured(direct_answer: dict[str, Any]) -> bool:
    return (
