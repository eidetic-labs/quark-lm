...
def gate_action(name: str) -> dict[str, Any]:
    if name == "admission_probe_audit":
        return {
            ...
            "command": "PYTHONPATH=src python3 -m closed_world_lm.admission_probes",
    ...
    if name == "glossary_probe_audit":
        return {
            ...
            "command": "PYTHONPATH=src python3 -m closed_world_lm.glossary_probes",
...
def diagnose_report(report: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "rule_source": "closed_world_lm.self_diagnose",
