...
`training_replay_parity_pending` until every replay parity gate matches. When
the runtime or requested dtype is unavailable, it records a blocked or pending
case instead of fabricating metrics.
