...
13. **v0.87+:** a different safe update shape under the full baseline
...
- a different safe update shape that can improve branch diversity while keeping
  trained snapshots at or above baseline target-token coverage.
