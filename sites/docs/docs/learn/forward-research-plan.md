...
v0.69 is strategy evidence, v0.70 is deep research evidence, and v0.71-v0.79
...
continue eval and checkpoint-load extraction before another anti-collapse
objective or tokenizer migration.
...
implements transformer model/config and checkpoint metadata surfaces.
